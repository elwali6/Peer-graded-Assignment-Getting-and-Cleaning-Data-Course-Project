...
The data set that this code book pertains to is located in the `tidy2.txt` file of this repository.
...
The `tidy2.txt` data file is a text file, containing space-separated values.
